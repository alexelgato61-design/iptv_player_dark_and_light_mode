# Important instructions for GitHub Copilot
- Keep the code clean
...
- avoid generating large blocks of boilerplate code
- Focus on generating meaningful and relevant code snippets
- avoid generating documentation or explanations unless explicitly requested

# Project Description
This project is a desktop application built with Electron and React. It serves as a IPTV player, allowing users to stream and manage their IPTV subscriptions. The application features a user-friendly interface for browsing channels, managing playlists, and customizing viewing preferences. It supports various IPTV formats and provides functionalities such as EPG (Electronic Program Guide) integration, channel categorization, and video playback controls. The goal of the project is to deliver a seamless and enjoyable IPTV viewing experience on desktop platforms.
